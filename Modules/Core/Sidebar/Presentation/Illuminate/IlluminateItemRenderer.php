...
use Maatwebsite\Sidebar\Presentation\Illuminate\IlluminateItemRenderer as PackageItemRenderer;

class IlluminateItemRenderer extends PackageItemRenderer
{
    /**
     * @var Factory
     */
     ...
     * @var string
     */
    protected $view = 'core::sidebar.item';
