...
use Modules\Partners\Repositories\EloquentPartner;
...
class PartnersServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Partners',
            'Modules\Partners\Facades\Facade'
        );
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Partners\Repositories\PartnerInterface', function (Application $app) {
            $repository = new EloquentPartner(new Partner);
            return $repository;
        });

        $app->view->composer('partners::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('partners');
        });
    }
