...
use Modules\Zone\Repositories\EloquentZone;
...
class ZoneServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Zone\Repositories\ZoneInterface', function (Application $app) {
            $repository = new EloquentZone(new Zone);
            return $repository;
        });

        /*$app->view->composer('zone::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('zone');
        });*/
    }
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('zone.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'zone'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'zone');
        }
    }
