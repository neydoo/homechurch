<?php namespace Modules\Blocks\Http\Controllers;

use Modules\Core\Http\Controllers\BaseAdminController;
use Modules\Blocks\Http\Requests\FormRequest;
use Modules\Blocks\Repositories\BlockInterface as Repository;
...
class BlocksController extends BaseAdminController {
    ...
    public function update(Block $model,FormRequest $request)
    {
        $data = $request->all();
