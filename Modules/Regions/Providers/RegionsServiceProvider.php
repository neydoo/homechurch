...
use Modules\Regions\Repositories\EloquentRegion;
...
class RegionsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Regions',
            'Modules\Regions\Facades\Facade'
        );

        /*Region::observe(new SlugObserver());
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Regions\Repositories\RegionInterface', function (Application $app) {
            $repository = new EloquentRegion(new Region);
            return $repository;
        });

        /*$app->view->composer('regions::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('regions');
        });*/
    }
