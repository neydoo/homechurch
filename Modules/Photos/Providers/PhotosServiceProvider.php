...
use Modules\Photos\Repositories\EloquentPhoto;
...
class PhotosServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias(
            'Photos',
            'Modules\Photos\Facades\Facade'
        );

        /*Photo::observe(new SlugObserver());
        Photo::observe(new FileObserver());*/
    ...
    public function register()
    {
        ...
        $app->bind('Modules\Photos\Repositories\PhotoInterface', function (Application $app) {
            $repository = new EloquentPhoto(new Photo);
            return $repository;
        });

        /*$app->view->composer('photos::public.*', function ($view) {
            $view->page = \MyApp::getPageLinkedToModule('photos');
        });*/
    }
